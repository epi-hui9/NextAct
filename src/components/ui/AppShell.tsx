...
import Home from "@/features/journey/components/Home";
import Onboarding from "@/features/auth/components/Onboarding";
import NavBar, { type NavTab, type Tab } from "./NavBar";
import UpdateBanner from "./UpdateBanner";
import AccountSheet from "@/features/settings/components/AccountSheet";
import { clearDraft, loadDraft, saveDraft } from "@/features/conversation/client/draft-store";
import styles from "./AppShell.module.css";

const ConversationView = dynamic(
  () => import("@/features/conversation/components/ConversationView"),
  {
    ssr: false,
    loading: () => <div className={styles.lazy} aria-busy="true" />,
  },
);
const LegacyMap = dynamic(() => import("@/features/legacy/components/LegacyMap"), {
  ssr: false,
  loading: () => <div className={styles.lazy} aria-busy="true" />,
});
const Journey = dynamic(() => import("@/features/journey/components/Journey"), {
  ssr: false,
  loading: () => <div className={styles.lazy} aria-busy="true" />,
});
